...
const (
	...
	UserService_GetUserWallet_FullMethodName = "/auth.v1.UserService/GetUserWallet"
...
type UserServiceClient interface {
	...
	GetUserWallet(ctx context.Context, in *GetUserByWalletRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) GetUserWallet(ctx context.Context, in *GetUserByWalletRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	GetUserWallet(context.Context, *GetUserByWalletRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) GetUserWallet(context.Context, *GetUserByWalletRequest) (*UserResponse, error) {
...
func _UserService_GetUserWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserWallet(ctx, req.(*GetUserByWalletRequest))
	}
	return interceptor(ctx, in, info, handler)
}
